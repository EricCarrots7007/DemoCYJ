...
namespace CYJModels.Controllers
{
    public class HomeController : Controller
    {
        ...
        //[HttpPost]
        //public JsonResult AjaxMethodADD(string type, int value)
        //{
        //    CascadingModel model = new CascadingModel();
        //    switch (type)
        //    {
        //        case "teamID":
        //           model.WSTREAMS = GetWorkStream("INSERT INTO WSTREAM VALUES WStreamName", "TeamID");
        //            break;

        //        case "wstreamID":
        //            model.CATEGORIES = GetCategories("SELECT categID, categName FROM CATEGORY WHERE wstreamID = " + value, "categName", "categID");
        //            break;
        //        case "categID":
        //            model.SUBCATEGORIES = Getsubcategories("SELECT subcategID, subcategName FROM SUBCATEGORY WHERE categID = " + value, "subcategName", "subcategID");
        //            break;
        //        case "subcategID":
        //            model.AGOALS = GetAgoals("SELECT agoalID, agoalValue FROM AGOAL WHERE subcategID = " + value, "agoalValue", "agoalID");
        //            break;
        ...
        [HttpPost]
        public ActionResult Contact(int teamID, int wstreamID, int categID, int subcategID, string wstreamName)
        {
            CascadingModel model = new CascadingModel();
            model.TEAMS = PopulateDropDown("SELECT teamID, teamName FROM TEAM", "teamName", "teamID");
        ...
        //private static List<SelectListItem> GetWorkStream(string query, string textColumn, string valueColumn)
        //{
